...
import 'package:learning_designs/models/users/user_model.dart';
...
class UserScreen extends StatelessWidget
{
  ...
  static List<UserModel>users = [
    ...
    UserModel(id: 3, name: 'abdullah mostafa', phone: '01332661587'),
    UserModel(id: 4, name: 'osama samey', phone: '0198761587'),
    UserModel(id: 5, name: 'ali nour', phone: '05655461587'),
    UserModel(id: 1, name: 'yousef sherif', phone: '01122661587'),
    UserModel(id: 2, name: 'mohamed sherif', phone: '01122878707'),
    UserModel(id: 3, name: 'ashraf ahmed', phone: '01332661587'),
    UserModel(id: 4, name: 'osama samey', phone: '0198761587'),
    UserModel(id: 5, name: 'ali nour', phone: '05655461587'),
    UserModel(id: 1, name: 'yousef sherif', phone: '01122661587'),
    UserModel(id: 2, name: 'mohamed sherif', phone: '01122878707'),
    UserModel(id: 3, name: 'ashraf khaled', phone: '01332661587'),
    UserModel(id: 4, name: 'osama samey', phone: '0198761587'),
    UserModel(id: 5, name: 'ali nour', phone: '05655461587'),
